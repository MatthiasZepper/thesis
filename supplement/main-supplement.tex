...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
	\documentclass[modern,hyperref,watermark,histinit,minitoc,plain]{wwubio-thesis-en-supple}
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
% Draft Indication (watermark text to be used with the `watermark' option)
	\draftIndication{Supplementary methods, figures and results}
%
...
\renewcommand{\figurename}{Figure S\hspace{-0.2em}}
\renewcommand{\tablename}{Table S\hspace{-0.2em}}
\renewcommand{\chaptername}{Supplementary Chapter}
}

\addto\extrasenglish{
	\renewcommand\figureautorefname{Figure S\hspace{-0.2em}}
	\renewcommand{\tableautorefname}{Table S\hspace{-0.2em}}
}
...
% Introduction
 %\part{Introduction}
    \adjustmtc   %to sync the minitocs with the actual chapter
  	\include{introduction_enhancers}
  	\include{results_wgbs_supplement}
	\include{results_wgbs_betadist_supplement}
    \include{results_gammodels_supplement}
    \include{results_persistency_supplement}
	\include{results_wgbs_cchip_supplement}
	\include{results_deregulated_genes_supplement}
	\include{results_deregulated_genes_tinats_supplement}
	\include{results_enhancer_clustering_supplement}
	\include{results_enhancer_motifsregulation_supplement}
